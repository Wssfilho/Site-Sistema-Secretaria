                ...
                if (request.getMethod().equalsIgnoreCase("post")) {
                    ...
                    try {
                        ...
                        if (e.getSQLState().equals("23000")) { //23000 erro para integridade referencial
                            out.println("Erro: Departamento não encontrado. Verifique o Código do Departamento.<br>");
                        } // Código SQL para violação de restrição de integridade out.println("Erro: Departamento não encontrado. Verifique o Código do Departamento.<br>"); } 
                        else {
                            e.printStackTrace();
