...
<body>
    <header>
        <h2>Deletar Currículo</h2>
    </header>
    <main>
        <form action="deleteCurriculo.jsp" method="post">
        ...
        <%
            if (request.getMethod().equalsIgnoreCase("post")) {
                ...
                try {
                    ...
                    String sql = "DELETE FROM Curriculo WHERE CodigoCurso = ? AND CodigoDisciplina = ?";
                    ps = conn.prepareStatement(sql);
                    ps.setInt(1, codigoCurso);
                    ps.setInt(2, codigoDisciplina);
                    ps.executeUpdate();
                    out.println("Currículo deletado com sucesso!<br>");
                } catch (SQLException e) {
                    e.printStackTrace();
                    out.println("Erro ao deletar currículo: " + e.getMessage() + "<br>");
                } finally {
                    if (ps != null) ps.close();
